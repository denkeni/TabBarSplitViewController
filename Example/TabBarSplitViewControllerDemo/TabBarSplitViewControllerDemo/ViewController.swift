...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        constraints += NSLayoutConstraint.constraints(withVisualFormat: "V:[redButton]-30-[blueButton]-30-[greenButton]", options: NSLayoutFormatOptions(), metrics: nil, views: viewsDict)
    ...
    func showRed(_ sender: UIButton) {
    ...
    func showBlue(_ sender: UIButton) {
    ...
    func showGreen(_ sender: UIButton) {
        let vc = DetailViewController(secondaryWithNav: secondaryWithNav)
        vc.title = "Green"
